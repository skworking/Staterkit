        ...
        <div className="ti-modal-body">
          ...
          <div className="my-[1.5rem]">
            ...
            <div id="dismiss-alert" role="alert"
              ...
              <Link aria-label="anchor" className="ms-auto leading-none" href="#!" data-hs-remove-element="#dismiss-alert"><i
            ...
            <div id="dismiss-alert1" role="alert"
              ...
              <Link aria-label="anchor" className="ms-auto leading-none" href="#!" data-hs-remove-element="#dismiss-alert1"><i
                  className="fe fe-x !text-[0.8125rem] text-[#8c9097] dark:text-white/50"></i></Link>
            </div>
            ...
            <div id="dismiss-alert2" role="alert"
              ...
              <Link aria-label="anchor" className="ms-auto lh-1" href="#!" data-hs-remove-element="#dismiss-alert2"><i
                  className="fe fe-x !text-[0.8125rem] text-[#8c9097] dark:text-white/50"></i></Link>
            </div>
          </div>
        </div>
