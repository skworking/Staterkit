...
const Header = ({ local_varaiable, ThemeChanger }: any) => {
  ...
  const toggleFullscreen = () => {
    const element = document.documentElement as any; // Use type assertion here
    if (!document.fullscreenElement && !element.mozFullScreenElement && !element.webkitFullscreenElement) {
